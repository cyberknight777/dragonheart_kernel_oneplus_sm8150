...
static struct snd_soc_dai_link geminilake_dais[] = {
	...
	},
	{
		...
		.platform_name = "0000:00:0e.0",
		.no_pcm = 1,
		.codec_name = RT5682_DEV0_NAME,
		.codec_dai_name = RT5682_DAI_NAME,
...
static int geminilake_audio_probe(struct platform_device *pdev)
{
	...
	if (acpi_dev_present("RTL5682", NULL, -1)) {
		...
		for (i = 0; i < glk_audio_card_rt5682_m98357a.num_links; i++) {
			...
			geminilake_dais[i].codec_name = RT5682S_DEV0_NAME;
			geminilake_dais[i].codec_dai_name = RT5682S_DAI_NAME;
			break;
		}
	}
