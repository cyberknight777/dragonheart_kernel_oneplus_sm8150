...
/************************end of declaration************************/
 ...
 /*********************************************************************
                        function about i2c
 **********************************************************************/
static inline int m1120_up_i2c_read_block(dhall_data_t* dhall_data, u8 addr, u8 *data, u8 len)
{
	u8 reg_addr = addr;
	int err = 0;
...
static inline int m1120_up_i2c_write_block(dhall_data_t* dhall_data, u8 addr, u8 *data, u8 len)
{
	int err = 0;
	int idx = 0;
	int num = 0;
...
static inline void m1120_up_short_to_2byte(dhall_data_t* dhall_data, short x, u8 *hbyte, u8 *lbyte)
{
    dhall_data_t* p_hall_data = dhall_data;
...
static inline short m1120_up_2byte_to_short(dhall_data_t* dhall_data, u8 hbyte, u8 lbyte)
{
	short x = 0;
    dhall_data_t* p_hall_data = dhall_data;
...
static inline int m1120_up_clear_interrupt(dhall_data_t* dhall_data)
{
    int err = -1;
    u8 data = 0x00;
    dhall_data_t* p_hall_data = dhall_data;
 ...
 /*********************************************************************
                        internal power control function
 **********************************************************************/
static inline int m1120_up_power_ctl(dhall_data_t* dhall_data, bool on)
{
    int err = -1;
    dhall_data_t* p_hall_data = dhall_data;
...
static inline int m1120_up_set_operation_mode(dhall_data_t* dhall_data, int mode)
{
    dhall_data_t* p_hall_data = dhall_data;
...
static inline bool m1120_up_get_enable(dhall_data_t* dhall_data)
{
    dhall_data_t* p_hall_data = dhall_data;
    int enable = -1;
...
static inline void m1120_up_set_enable(dhall_data_t* dhall_data, bool enable)
{
    dhall_data_t* p_hall_data = dhall_data;
 ...
 /*********************************************************************
                interface implement for oneplus_motor.c
 **********************************************************************/
static inline bool m1120_up_get_enable_state(void)
{
    if (g_hall_data == NULL) {
...
static inline int m1120_up_set_enable_state(bool enable)
{
    if (g_hall_data == NULL) {
...
static inline bool m1120_up_is_power_on(void)
{
    if (g_hall_data == NULL) {
...
static inline int m1120_up_get_real_data(short* data)
{ 
    int err = 0;
	u8 buf[3] = {0};
	short value = 0;
...
static inline int m1120_up_get_abs_data(short* data)
{ 
    short value = 0;
    int err = -1;
...
static inline int m1120_up_set_detection_mode(u8 mode)
{
	u8 data = 0;
	int err = 0;
...
static inline int m1120_up_enable_irq(bool enable)
{
    if(g_hall_data == NULL) {
        MOTOR_ERR("g_hall_data == NULL");
        return -EINVAL;
...
static inline int m1120_up_clear_irq(void)
{
    if(g_hall_data == NULL) {
        MOTOR_ERR("g_hall_data == NULL");
        return -EINVAL;
...
static inline int m1120_up_get_irq_state(void)
{
    if(g_hall_data == NULL) {
        MOTOR_ERR("g_hall_data == NULL");
        return -EINVAL;
...
static inline bool m1120_up_update_threshold(int position, short lowthd, short highthd)
{
...
static inline void m1120_up_dump_reg(u8* buf)
{
    int i, err;
	u8 val;
	u8 buffer[512] = {0};
...
static inline int m1120_up_set_reg(int reg, int val)
{
    u8 data = (u8)val;
...
static inline void m1120_up_set_sensitive(hall_sensitive_t sensitive)
{
    int err = 0;
    u8  data = 0x00;
...
struct oneplus_hall_operations m1120_up_ops = {
 ...
 /*********************************************************************
                        init function
 **********************************************************************/
static inline int m1120_up_init_device(dhall_data_t* hall_data)
{
    int err = -1;
...
static inline int m1120_up_reset_device(dhall_data_t* dhall_data)
{
    int err = 0;
...
static inline int m1120_up_power_init(dhall_data_t* dhall_data)
{
    int err = -1;
    dhall_data_t* p_hall_data = dhall_data;
...
static inline int m1120_up_parse_dt(dhall_data_t* dhall_data)
{
...
static inline int m1120_up_i2c_drv_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
...
static inline int m1120_up_i2c_drv_remove(struct i2c_client *client)
{
