...
static DEVICE_ATTR(infrared_power_enable, 0644, infrared_power_enable_show, infrared_power_enable_store);
static DEVICE_ATTR(infrared_shut_down_state, 0644, infrared_shut_down_state_show, infrared_shut_down_state_store);
static DEVICE_ATTR(infrared_shut_down_state2, 0644, infrared_shut_down_state2_show, infrared_shut_down_state2_store);
